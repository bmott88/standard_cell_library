...
C {devices/lab_pin.sym} 0 -30 1 0 {name=p5 sig_type=std_logic lab=sel}
...
C {devices/vsource.sym} -250 60 0 0 {name=V2 value="pulse(1.8 0 0 1p 1p 4n 8n)" savecurrent=false}
C {devices/gnd.sym} -250 90 0 0 {name=l3 lab=GND}
C {devices/lab_pin.sym} -250 -100 1 0 {name=p8 sig_type=std_logic lab=sel}
C {devices/vsource.sym} -250 -70 0 0 {name=V4 value="pulse(1.8 0 0 1p 1p 2n 4n)" savecurrent=false}
C {devices/gnd.sym} -250 -40 0 0 {name=l5 lab=GND}
C {devices/lab_pin.sym} -250 30 1 0 {name=p9 sig_type=std_logic lab=in}
C {devices/noconn.sym} 80 0 2 0 {name=l6}
C {ip/tgate/tgate_6t.sym} 0 0 0 0 {name=x1}
