...
N 260 -0 300 0 {lab=out}
C {ip/inv/inv.sym} -200 0 0 0 {name=x1}
C {ip/inv/inv.sym} 0 0 0 0 {name=x2}
C {ip/inv/inv.sym} 200 0 0 0 {name=x3}
C {devices/lab_pin.sym} -200 -30 1 0 {name=p1 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 0 -30 1 0 {name=p2 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 200 -30 1 0 {name=p3 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} -200 30 3 0 {name=p4 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 0 30 3 0 {name=p5 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 200 30 3 0 {name=p6 sig_type=std_logic lab=VSS}
